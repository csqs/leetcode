...
Update time:  2018-04-17 16:29:25

Auto created by [leetcode_generate](https://github.com/bonfy/leetcode)

I have solved **99   /   734** problems
while there are **133** problems still locked.

If you want to use this tool please follow this [Usage Guide](https://github.com/bonfy/leetcode/blob/master/README_leetcode_generate.md)

If you have any question, please give me an [issue](https://github.com/csqs/leetcode/issues).
...
|:---:|:---:|:---:|:---:|:---:|
|1|[two-sum](https://leetcode.com/problems/two-sum)|[Cpp](https://github.com/csqs/leetcode/blob/master/001-two-sum/two-sum.cpp)|[:memo:](https://leetcode.com/articles/two-sum/)|Easy|
|2|[add-two-numbers](https://leetcode.com/problems/add-two-numbers)|[Cpp](https://github.com/csqs/leetcode/blob/master/002-add-two-numbers/add-two-numbers.cpp)|[:memo:](https://leetcode.com/articles/add-two-numbers/)|Medium|
|3|[longest-substring-without-repeating-characters](https://leetcode.com/problems/longest-substring-without-repeating-characters)|[Cpp](https://github.com/csqs/leetcode/blob/master/003-longest-substring-without-repeating-characters/longest-substring-without-repeating-characters.cpp)|[:memo:](https://leetcode.com/articles/longest-substring-without-repeating-characters/)|Medium|
...
|5|[longest-palindromic-substring](https://leetcode.com/problems/longest-palindromic-substring)|[Cpp](https://github.com/csqs/leetcode/blob/master/005-longest-palindromic-substring/longest-palindromic-substring.cpp)|[:memo:](https://leetcode.com/articles/longest-palindromic-substring/)|Medium|
|6|[zigzag-conversion](https://leetcode.com/problems/zigzag-conversion)|[Cpp](https://github.com/csqs/leetcode/blob/master/006-zigzag-conversion/zigzag-conversion.cpp)||Medium|
|7|[reverse-integer](https://leetcode.com/problems/reverse-integer)|[Cpp](https://github.com/csqs/leetcode/blob/master/007-reverse-integer/reverse-integer.cpp)||Easy|
|8|[string-to-integer-atoi](https://leetcode.com/problems/string-to-integer-atoi)|[Cpp](https://github.com/csqs/leetcode/blob/master/008-string-to-integer-atoi/string-to-integer-atoi.cpp)||Medium|
|9|[palindrome-number](https://leetcode.com/problems/palindrome-number)|[Cpp](https://github.com/csqs/leetcode/blob/master/009-palindrome-number/palindrome-number.cpp)|[:memo:](https://leetcode.com/articles/palindrome-number/)|Easy|
|10|[regular-expression-matching](https://leetcode.com/problems/regular-expression-matching)|[Cpp](https://github.com/csqs/leetcode/blob/master/010-regular-expression-matching/regular-expression-matching.cpp)|[:memo:](https://leetcode.com/articles/regular-expression-matching/)|Hard|
|11|[container-with-most-water](https://leetcode.com/problems/container-with-most-water)|[Cpp](https://github.com/csqs/leetcode/blob/master/011-container-with-most-water/container-with-most-water.cpp)|[:memo:](https://leetcode.com/articles/container-most-water/)|Medium|
|12|[integer-to-roman](https://leetcode.com/problems/integer-to-roman)|||Medium|
|13|[roman-to-integer](https://leetcode.com/problems/roman-to-integer)|||Easy|
|14|[longest-common-prefix](https://leetcode.com/problems/longest-common-prefix)|[Cpp](https://github.com/csqs/leetcode/blob/master/014-longest-common-prefix/longest-common-prefix.cpp)|[:memo:](https://leetcode.com/articles/longest-common-prefix/)|Easy|
|15|[3sum](https://leetcode.com/problems/3sum)|[Cpp](https://github.com/csqs/leetcode/blob/master/015-3sum/3sum.cpp)||Medium|
|16|[3sum-closest](https://leetcode.com/problems/3sum-closest)|[Cpp](https://github.com/csqs/leetcode/blob/master/016-3sum-closest/3sum-closest.cpp)||Medium|
|17|[letter-combinations-of-a-phone-number](https://leetcode.com/problems/letter-combinations-of-a-phone-number)|[Cpp](https://github.com/csqs/leetcode/blob/master/017-letter-combinations-of-a-phone-number/letter-combinations-of-a-phone-number.cpp)||Medium|
|18|[4sum](https://leetcode.com/problems/4sum)|[Cpp](https://github.com/csqs/leetcode/blob/master/018-4sum/4sum.cpp)||Medium|
|19|[remove-nth-node-from-end-of-list](https://leetcode.com/problems/remove-nth-node-from-end-of-list)|[Cpp](https://github.com/csqs/leetcode/blob/master/019-remove-nth-node-from-end-of-list/remove-nth-node-from-end-of-list.cpp)|[:memo:](https://leetcode.com/articles/remove-nth-node-end-list/)|Medium|
|20|[valid-parentheses](https://leetcode.com/problems/valid-parentheses)|[Cpp](https://github.com/csqs/leetcode/blob/master/020-valid-parentheses/valid-parentheses.cpp)||Easy|
...
|22|[generate-parentheses](https://leetcode.com/problems/generate-parentheses)|[Cpp](https://github.com/csqs/leetcode/blob/master/022-generate-parentheses/generate-parentheses.cpp)|[:memo:](https://leetcode.com/articles/generate-parentheses/)|Medium|
...
|29|[divide-two-integers](https://leetcode.com/problems/divide-two-integers)|[Cpp](https://github.com/csqs/leetcode/blob/master/029-divide-two-integers/divide-two-integers.cpp)||Medium|
|30|[substring-with-concatenation-of-all-words](https://leetcode.com/problems/substring-with-concatenation-of-all-words)|||Hard|
|31|[next-permutation](https://leetcode.com/problems/next-permutation)|[Cpp](https://github.com/csqs/leetcode/blob/master/031-next-permutation/next-permutation.cpp)|[:memo:](https://leetcode.com/articles/next-permutation/)|Medium|
...
|34|[search-for-a-range](https://leetcode.com/problems/search-for-a-range)|[Cpp](https://github.com/csqs/leetcode/blob/master/034-search-for-a-range/search-for-a-range.cpp)|[:memo:](https://leetcode.com/articles/search-for-a-range/)|Medium|
|35|[search-insert-position](https://leetcode.com/problems/search-insert-position)|[Cpp](https://github.com/csqs/leetcode/blob/master/035-search-insert-position/search-insert-position.cpp)||Easy|
|36|[valid-sudoku](https://leetcode.com/problems/valid-sudoku)|||Medium|
|37|[sudoku-solver](https://leetcode.com/problems/sudoku-solver)|||Hard|
|38|[count-and-say](https://leetcode.com/problems/count-and-say)|||Easy|
|39|[combination-sum](https://leetcode.com/problems/combination-sum)|[Cpp](https://github.com/csqs/leetcode/blob/master/039-combination-sum/combination-sum.cpp)||Medium|
|40|[combination-sum-ii](https://leetcode.com/problems/combination-sum-ii)|[Cpp](https://github.com/csqs/leetcode/blob/master/040-combination-sum-ii/combination-sum-ii.cpp)||Medium|
...
|43|[multiply-strings](https://leetcode.com/problems/multiply-strings)|[Cpp](https://github.com/csqs/leetcode/blob/master/043-multiply-strings/multiply-strings.cpp)||Medium|
|44|[wildcard-matching](https://leetcode.com/problems/wildcard-matching)|||Hard|
|45|[jump-game-ii](https://leetcode.com/problems/jump-game-ii)|||Hard|
|46|[permutations](https://leetcode.com/problems/permutations)|[Cpp](https://github.com/csqs/leetcode/blob/master/046-permutations/permutations.cpp)||Medium|
|47|[permutations-ii](https://leetcode.com/problems/permutations-ii)|[Cpp](https://github.com/csqs/leetcode/blob/master/047-permutations-ii/permutations-ii.cpp)||Medium|
...
|50|[powx-n](https://leetcode.com/problems/powx-n)|[Cpp](https://github.com/csqs/leetcode/blob/master/050-powx-n/powx-n.cpp)|[:memo:](https://leetcode.com/articles/powx-n/)|Medium|
...
|62|[unique-paths](https://leetcode.com/problems/unique-paths)|[Cpp](https://github.com/csqs/leetcode/blob/master/062-unique-paths/unique-paths.cpp)||Medium|
|63|[unique-paths-ii](https://leetcode.com/problems/unique-paths-ii)|[Cpp](https://github.com/csqs/leetcode/blob/master/063-unique-paths-ii/unique-paths-ii.cpp)||Medium|
|64|[minimum-path-sum](https://leetcode.com/problems/minimum-path-sum)|[Cpp](https://github.com/csqs/leetcode/blob/master/064-minimum-path-sum/minimum-path-sum.cpp)|[:memo:](https://leetcode.com/articles/minimum-path-sum/)|Medium|
|65|[valid-number](https://leetcode.com/problems/valid-number)|||Hard|
|66|[plus-one](https://leetcode.com/problems/plus-one)|[Cpp](https://github.com/csqs/leetcode/blob/master/066-plus-one/plus-one.cpp)||Easy|
|67|[add-binary](https://leetcode.com/problems/add-binary)|[Cpp](https://github.com/csqs/leetcode/blob/master/067-add-binary/add-binary.cpp)||Easy|
|68|[text-justification](https://leetcode.com/problems/text-justification)|||Hard|
|69|[sqrtx](https://leetcode.com/problems/sqrtx)|[Cpp](https://github.com/csqs/leetcode/blob/master/069-sqrtx/sqrtx.cpp)||Easy|
|70|[climbing-stairs](https://leetcode.com/problems/climbing-stairs)|[Cpp](https://github.com/csqs/leetcode/blob/master/070-climbing-stairs/climbing-stairs.cpp)|[:memo:](https://leetcode.com/articles/climbing-stairs/)|Easy|
...
|77|[combinations](https://leetcode.com/problems/combinations)|[Cpp](https://github.com/csqs/leetcode/blob/master/077-combinations/combinations.cpp)||Medium|
...
|94|[binary-tree-inorder-traversal](https://leetcode.com/problems/binary-tree-inorder-traversal)|[Cpp](https://github.com/csqs/leetcode/blob/master/094-binary-tree-inorder-traversal/binary-tree-inorder-traversal.cpp)|[:memo:](https://leetcode.com/articles/binary-tree-inorder-traversal/)|Medium|
|95|[unique-binary-search-trees-ii](https://leetcode.com/problems/unique-binary-search-trees-ii)|[Cpp](https://github.com/csqs/leetcode/blob/master/095-unique-binary-search-trees-ii/unique-binary-search-trees-ii.cpp)||Medium|
|96|[unique-binary-search-trees](https://leetcode.com/problems/unique-binary-search-trees)|[Cpp](https://github.com/csqs/leetcode/blob/master/096-unique-binary-search-trees/unique-binary-search-trees.cpp)||Medium|
...
|108|[convert-sorted-array-to-binary-search-tree](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree)|[Cpp](https://github.com/csqs/leetcode/blob/master/108-convert-sorted-array-to-binary-search-tree/convert-sorted-array-to-binary-search-tree.cpp)||Easy|
|109|[convert-sorted-list-to-binary-search-tree](https://leetcode.com/problems/convert-sorted-list-to-binary-search-tree)|[Cpp](https://github.com/csqs/leetcode/blob/master/109-convert-sorted-list-to-binary-search-tree/convert-sorted-list-to-binary-search-tree.cpp)||Medium|
|110|[balanced-binary-tree](https://leetcode.com/problems/balanced-binary-tree)|||Easy|
|111|[minimum-depth-of-binary-tree](https://leetcode.com/problems/minimum-depth-of-binary-tree)|||Easy|
|112|[path-sum](https://leetcode.com/problems/path-sum)|[Cpp](https://github.com/csqs/leetcode/blob/master/112-path-sum/path-sum.cpp)||Easy|
|113|[path-sum-ii](https://leetcode.com/problems/path-sum-ii)|[Cpp](https://github.com/csqs/leetcode/blob/master/113-path-sum-ii/path-sum-ii.cpp)||Medium|
...
|129|[sum-root-to-leaf-numbers](https://leetcode.com/problems/sum-root-to-leaf-numbers)|[Cpp](https://github.com/csqs/leetcode/blob/master/129-sum-root-to-leaf-numbers/sum-root-to-leaf-numbers.cpp)||Medium|
...
|144|[binary-tree-preorder-traversal](https://leetcode.com/problems/binary-tree-preorder-traversal)|[Cpp](https://github.com/csqs/leetcode/blob/master/144-binary-tree-preorder-traversal/binary-tree-preorder-traversal.cpp)||Medium|
|145|[binary-tree-postorder-traversal](https://leetcode.com/problems/binary-tree-postorder-traversal)|[Cpp](https://github.com/csqs/leetcode/blob/master/145-binary-tree-postorder-traversal/binary-tree-postorder-traversal.cpp)||Hard|
...
|167|[two-sum-ii-input-array-is-sorted](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted)|[Cpp](https://github.com/csqs/leetcode/blob/master/167-two-sum-ii-input-array-is-sorted/two-sum-ii-input-array-is-sorted.cpp)|[:memo:](https://leetcode.com/articles/two-sum-ii-input-array-sorted/)|Easy|
...
|172|[factorial-trailing-zeroes](https://leetcode.com/problems/factorial-trailing-zeroes)|[Cpp](https://github.com/csqs/leetcode/blob/master/172-factorial-trailing-zeroes/factorial-trailing-zeroes.cpp)||Easy|
...
|191|[number-of-1-bits](https://leetcode.com/problems/number-of-1-bits)|[Cpp](https://github.com/csqs/leetcode/blob/master/191-number-of-1-bits/number-of-1-bits.cpp)|[:memo:](https://leetcode.com/articles/number-1-bits/)|Easy|
...
|205|[isomorphic-strings](https://leetcode.com/problems/isomorphic-strings)|[Cpp](https://github.com/csqs/leetcode/blob/master/205-isomorphic-strings/isomorphic-strings.cpp)||Easy|
...
|209|[minimum-size-subarray-sum](https://leetcode.com/problems/minimum-size-subarray-sum)|[Cpp](https://github.com/csqs/leetcode/blob/master/209-minimum-size-subarray-sum/minimum-size-subarray-sum.cpp)|[:memo:](https://leetcode.com/articles/minimum-size-subarray-sum/)|Medium|
...
|216|[combination-sum-iii](https://leetcode.com/problems/combination-sum-iii)|[Cpp](https://github.com/csqs/leetcode/blob/master/216-combination-sum-iii/combination-sum-iii.cpp)||Medium|
...
|231|[power-of-two](https://leetcode.com/problems/power-of-two)|[Cpp](https://github.com/csqs/leetcode/blob/master/231-power-of-two/power-of-two.cpp)||Easy|
...
|233|[number-of-digit-one](https://leetcode.com/problems/number-of-digit-one)|[Cpp](https://github.com/csqs/leetcode/blob/master/233-number-of-digit-one/number-of-digit-one.cpp)|[:memo:](https://leetcode.com/articles/number-of-digit-one/)|Hard|
...
|241|[different-ways-to-add-parentheses](https://leetcode.com/problems/different-ways-to-add-parentheses)|[Cpp](https://github.com/csqs/leetcode/blob/master/241-different-ways-to-add-parentheses/different-ways-to-add-parentheses.cpp)||Medium|
...
|257|[binary-tree-paths](https://leetcode.com/problems/binary-tree-paths)|[Cpp](https://github.com/csqs/leetcode/blob/master/257-binary-tree-paths/binary-tree-paths.cpp)||Easy|
...
|263|[ugly-number](https://leetcode.com/problems/ugly-number)|[Cpp](https://github.com/csqs/leetcode/blob/master/263-ugly-number/ugly-number.cpp)||Easy|
|264|[ugly-number-ii](https://leetcode.com/problems/ugly-number-ii)|[Cpp](https://github.com/csqs/leetcode/blob/master/264-ugly-number-ii/ugly-number-ii.cpp)||Medium|
...
|273|[integer-to-english-words](https://leetcode.com/problems/integer-to-english-words)|[Cpp](https://github.com/csqs/leetcode/blob/master/273-integer-to-english-words/integer-to-english-words.cpp)||Hard|
...
|278|[first-bad-version](https://leetcode.com/problems/first-bad-version)|[Cpp](https://github.com/csqs/leetcode/blob/master/278-first-bad-version/first-bad-version.cpp)|[:memo:](https://leetcode.com/articles/first-bad-version/)|Easy|
...
|290|[word-pattern](https://leetcode.com/problems/word-pattern)|[Cpp](https://github.com/csqs/leetcode/blob/master/290-word-pattern/word-pattern.cpp)||Easy|
...
|315|[count-of-smaller-numbers-after-self](https://leetcode.com/problems/count-of-smaller-numbers-after-self)|[Cpp](https://github.com/csqs/leetcode/blob/master/315-count-of-smaller-numbers-after-self/count-of-smaller-numbers-after-self.cpp)||Hard|
...
|326|[power-of-three](https://leetcode.com/problems/power-of-three)|[Cpp](https://github.com/csqs/leetcode/blob/master/326-power-of-three/power-of-three.cpp)|[:memo:](https://leetcode.com/articles/power-of-three/)|Easy|
...
|338|[counting-bits](https://leetcode.com/problems/counting-bits)|[Cpp](https://github.com/csqs/leetcode/blob/master/338-counting-bits/counting-bits.cpp)|[:memo:](https://leetcode.com/articles/counting-bits/)|Medium|
...
|342|[power-of-four](https://leetcode.com/problems/power-of-four)|[Cpp](https://github.com/csqs/leetcode/blob/master/342-power-of-four/power-of-four.cpp)||Easy|
...
|372|[super-pow](https://leetcode.com/problems/super-pow)|[Cpp](https://github.com/csqs/leetcode/blob/master/372-super-pow/super-pow.cpp)||Medium|
...
|377|[combination-sum-iv](https://leetcode.com/problems/combination-sum-iv)|[Cpp](https://github.com/csqs/leetcode/blob/master/377-combination-sum-iv/combination-sum-iv.cpp)||Medium|
...
|401|[binary-watch](https://leetcode.com/problems/binary-watch)|[Cpp](https://github.com/csqs/leetcode/blob/master/401-binary-watch/binary-watch.cpp)||Easy|
...
|415|[add-strings](https://leetcode.com/problems/add-strings)|[Cpp](https://github.com/csqs/leetcode/blob/master/415-add-strings/add-strings.cpp)||Easy|
...
|437|[path-sum-iii](https://leetcode.com/problems/path-sum-iii)|[Cpp](https://github.com/csqs/leetcode/blob/master/437-path-sum-iii/path-sum-iii.cpp)||Easy|
...
|464|[can-i-win](https://leetcode.com/problems/can-i-win)|[Cpp](https://github.com/csqs/leetcode/blob/master/464-can-i-win/can-i-win.cpp)||Medium|
...
|486|[predict-the-winner](https://leetcode.com/problems/predict-the-winner)|[Cpp](https://github.com/csqs/leetcode/blob/master/486-predict-the-winner/predict-the-winner.cpp)|[:memo:](https://leetcode.com/articles/predict-the-winner/)|Medium|
...
|493|[reverse-pairs](https://leetcode.com/problems/reverse-pairs)|[Cpp](https://github.com/csqs/leetcode/blob/master/493-reverse-pairs/reverse-pairs.cpp)|[:memo:](https://leetcode.com/articles/reverse-pairs/)|Hard|
...
|523|[continuous-subarray-sum](https://leetcode.com/problems/continuous-subarray-sum)|[Cpp](https://github.com/csqs/leetcode/blob/master/523-continuous-subarray-sum/continuous-subarray-sum.cpp)|[:memo:](https://leetcode.com/articles/continous-subarray-sum/)|Medium|
...
|560|[subarray-sum-equals-k](https://leetcode.com/problems/subarray-sum-equals-k)|[Cpp](https://github.com/csqs/leetcode/blob/master/560-subarray-sum-equals-k/subarray-sum-equals-k.cpp)|[:memo:](https://leetcode.com/articles/subarray-sum-equals-k/)|Medium|
...
|566|[reshape-the-matrix](https://leetcode.com/problems/reshape-the-matrix)|[Cpp](https://github.com/csqs/leetcode/blob/master/566-reshape-the-matrix/reshape-the-matrix.cpp)|[:memo:](https://leetcode.com/articles/reshape-the-matrix/)|Easy|
...
|623|[add-one-row-to-tree](https://leetcode.com/problems/add-one-row-to-tree)|[Cpp](https://github.com/csqs/leetcode/blob/master/623-add-one-row-to-tree/add-one-row-to-tree.cpp)|[:memo:](https://leetcode.com/articles/add-one-row-in-a-tree/)|Medium|
...
|653|[two-sum-iv-input-is-a-bst](https://leetcode.com/problems/two-sum-iv-input-is-a-bst)|[Cpp](https://github.com/csqs/leetcode/blob/master/653-two-sum-iv-input-is-a-bst/two-sum-iv-input-is-a-bst.cpp)|[:memo:](https://leetcode.com/articles/two-sum-iv/)|Easy|
...
|687|[longest-univalue-path](https://leetcode.com/problems/longest-univalue-path)|[Cpp](https://github.com/csqs/leetcode/blob/master/687-longest-univalue-path/longest-univalue-path.cpp)|[:memo:](https://leetcode.com/articles/longest-univalue-path/)|Easy|
...
|718|[maximum-length-of-repeated-subarray](https://leetcode.com/problems/maximum-length-of-repeated-subarray)|[Cpp](https://github.com/csqs/leetcode/blob/master/718-maximum-length-of-repeated-subarray/maximum-length-of-repeated-subarray.cpp)|[:memo:](https://leetcode.com/articles/maximum-length-of-repeated-subarray/)|Medium|
...
|747|[min-cost-climbing-stairs](https://leetcode.com/problems/min-cost-climbing-stairs)|[Cpp](https://github.com/csqs/leetcode/blob/master/747-min-cost-climbing-stairs/min-cost-climbing-stairs.cpp)|[:memo:](https://leetcode.com/articles/min-cost-climbing-stairs/)|Easy|
